 ...
 * Work Queue – Worker 1.
 *
 * Cùng listen trên queue "task_queue" với Worker2.
 * RabbitMQ phân phối round-robin + fair dispatch (prefetch=1):
 *   → Mỗi message chỉ được XỬ LÝ BỞI 1 WORKER duy nhất.
 *   → Worker nào xong trước thì nhận task tiếp theo.
 */
@Component
